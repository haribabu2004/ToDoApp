...
function Home() {
    ...
    const handleEditSave = (id) => {
        ...
        axios.put(`http://localhost:3001/update/edit/${id}`, { task: editTask })
            .then(res => {
                console.log(res);
    ...
    axios.put(`http://localhost:3001/update/${id}`, { completed: updatedCompleted })
        .then(res => {
    ...
    return (
        <div className='min-h-screen w-full bg-stone-950'>
            <div className='flex flex-col items-center justify-center pt-3 bg-stone-950'>
                                    ...
                                    <div key={index} className='w-full bg-white p-3 rounded-lg shadow-md'>
                                        <div className='flex justify-between items-center'>
                                            <BsCircleFill
                                                ...
                                                className={`cursor-pointer text-xl ${item.completed ? 'text-green-600' : 'text-gray-400'} hover:text-green-600`}
                                            />
                                            {
                                                editId === item._id ? (
                                                    <input
                                            ...
                                            <MdEdit className='cursor-pointer hover:text-blue-600' onClick={() => handleEdit(item)} />
